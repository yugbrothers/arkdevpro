      ...
      <div className="ln-hero-content">
        <div className="ln-hero-left">
          <Link to="/backgrounds/line-waves" className="ln-hero-tag">
            <span className="ln-hero-tag-new" style={{ background: accentColor, color: accentFg }}>New Release</span>
            Line Waves <FaArrowRight size={10} />
          </Link>
          <h1 className="ln-hero-headline">
            <span className="ln-hero-headline-line">Build Faster with</span><br />
            <span className="ln-hero-headline-line" style={{
          ...
          <p className="ln-hero-description">
            Modern developer components, templates, UI kits, developer tools, and premium resources for professionals.
          </p>
          <div className="ln-hero-buttons" style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
            <Link to="/get-started/index" className="ln-hero-btn ln-hero-btn-primary" style={{ background: accentColor, borderColor: accentColor, color: accentFg, textDecoration: 'none' }}>
              Browse Components
            </Link>
            <ElectricBorder color="#ec4899" speed={1.2} chaos={0.08} borderRadius={12}>
        ...
        {/* Statistics Section */}
        <div className="ln-hero-stats-wrapper">
          <p className="ln-hero-stats-title">Trusted by developers worldwide</p>
          <div className="ln-hero-stats">
            <div className="ln-hero-stat-card">
              <div className="ln-hero-stat-number">10,000+</div>
              <div className="ln-hero-stat-label">Components</div>
            </div>
            <div className="ln-hero-stat-card">
              <div className="ln-hero-stat-number">500+</div>
              <div className="ln-hero-stat-label">Templates</div>
            </div>
            <div className="ln-hero-stat-card">
              <div className="ln-hero-stat-number">5,000+</div>
              <div className="ln-hero-stat-label">Developers</div>
            </div>
            <div className="ln-hero-stat-card">
              <div className="ln-hero-stat-number">99.9%</div>
              <div className="ln-hero-stat-label">Uptime</div>
            </div>
          </div>
        </div>
